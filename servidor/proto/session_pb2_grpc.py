...
def add_LoginServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'session.LoginService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('session.LoginService', rpc_method_handlers)
...
class LoginService(object):
    ...
    def Login(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/session.LoginService/Login',
            session__pb2.LoginRequest.SerializeToString,
            session__pb2.LoginResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
