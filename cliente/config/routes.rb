Rails.application.routes.draw do
	...
	get "inventarios"			=> "inventario#index"
	get "inventario/alta"		=> "inventario#altaform"
	get "inventario/mod/:id"	=> "inventario#modform"
	get "inventario/baja/:id"	=> "inventario#bajaform"
	post "inventario/alta"		=> "inventario#altapost"
	post "inventario/mod/:id"	=> "inventario#modpost"
	post "inventario/baja/:id"	=> "inventario#bajapost"
